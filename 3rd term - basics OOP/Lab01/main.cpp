/* 
   ...
   Rozwiązanie w formie spakowanych wszystkich plików źródłowych proszę umieścić w katalogu o nazwie
   nr_rupy_lab1_nazwisko, z którego należy utworzyć archiwum nr_grupy_lab1_nazwisko.tar.gz
